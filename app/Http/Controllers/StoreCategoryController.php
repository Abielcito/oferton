...
class StoreCategoryController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('store_categories.index')
    ...
    {
        return view('store_categories.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('store_categories.show')->with('storeCategory', $storeCategory);
    }
    ...
    public function edit($id)
    {
        ...
        return view('store_categories.edit')->with('storeCategory', $storeCategory);
    }
