...
class MainController extends Controller {
    ...
    protected function findProductsByCardDiscount($store, $cardDiscount) {
        ...
        return $customResult;
//        $customResult = $this->formatArrayProducts($result);
//        $customResult = collect($customResult)->filter(function ($product,$cardDiscount) {
//            return $product->discountPercentWithCard >= $cardDiscount;
//        })->sortBy('discountPercentWithCard')->reverse()->toArray();        
        return $customResult;
    }
